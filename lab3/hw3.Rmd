...
```{r}
name <- c("mount_everest", "k2", "kangchenjunga", "lhoste", "makalu")
height_f <- c(29032, 28251, 28169, 27940,27832)
...
```{r}
mountains <- tibble(name, height_f, height_m)
```

**3. What is the mean height of the mountains in feet?**
```{r}
mean(mountains$height_f)
```
...
```{r}
mountains<- tibble(name, height_f, height_m, first_climbed)
```
...
```{r}
summits <-  c(5656,800, 243, 461, 361)
mountains<- tibble(name, height_f, height_m, first_climbed, summits)
...
```{r}
fatalities <-  c(223, 96, 40, 13, 31)
mountains<- tibble(name, height_f, height_m, first_climbed, summits, fatalities)
```
...
mountains<- tibble(name, height_f, height_m, first_climbed, summits, fatalities, fatality_rate)
```
