...
ggplot(data = gabon_clean_f,
  ...
  labs(title = "Land use type per Number of Transects")
```
...
gabon_clean_f %>%
  ...
  labs(title = "Land use type vs Vegetation Richness")
```
...
gabon_clean_f %>%
  ...
  geom_boxplot(mapping = aes(fill = land_use))+
  labs(title = "Land use type vs Species Diversity")
```
...
gabon_clean_f %>%
  ...
  labs(title = "Mammal Speices Diversity vs Vegetation Richness")
