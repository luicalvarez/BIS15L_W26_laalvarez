...
amniota_no_na %>% 
  ...
  miss_var_summary() %>% 
  arrange(desc(n_miss))
# Reptiles have the largest number of missing data, I would expect mammals to have more missing data as mammal eggs seem to me to be harder to record and mesure
```
